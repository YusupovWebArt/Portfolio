...
function getBotAnswer(question: string) {
  ...
  return "I'm not sure about that. Try selecting one of the suggested questions below, or ask about my skills, experience, location, or English level."
}
...
const ChatModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-slate-955/40 dark:bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-all duration-300">
