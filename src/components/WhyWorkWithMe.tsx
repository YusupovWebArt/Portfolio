    ...
    <section className="py-20 bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          {/* Opening Statement */}
          <div className="bg-white dark:bg-slate-800 lg:bg-white/70 lg:dark:bg-slate-800/70 lg:backdrop-blur-sm rounded-3xl p-6 sm:p-8 mb-12 border border-slate-200/50 dark:border-slate-700/50 shadow-lg">
