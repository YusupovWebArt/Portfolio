...
const rolenConstruction: Project = {
  ...
  features: [
    ...
    <p>
      <strong>Elementor Page Builder: </strong> Integrated for the creation of
      <strong> inner service landing pages</strong> tailored to client
      requirements, offering an intuitive drag-and-drop interface for easy
      content management.
    </p>,
    <p>
