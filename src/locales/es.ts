...
export const es: Translation = {
  ...
  whyMe: {
    ...
    title: {
      before: 'Por qué trabajar conmigo es',
      highlight: 'rentable',
      after: 'para su negocio',
    },
    description:
      'Asociarse conmigo es una inversión estratégica en velocidad, cumplimiento normativo y posicionamiento de futuro. Así es como aporto valor empresarial tangible a sus productos digitales:',
    card1: {
      title: 'Velocidad de desarrollo orientada al negocio',
      subtitle: 'Ingeniería agéntica y tiempo de comercialización 3 veces menor',
      body: 'Aprovecho entornos de IA agéntica avanzados para acelerar los ciclos de desarrollo 3 veces. Al automatizar la generación de sintaxis rutinaria, desplazo el enfoque de ingeniería hacia la arquitectura de sistemas, revisiones de código exhaustivas y gestión robusta de errores — reduciendo drásticamente los costes de desarrollo y el tiempo de entrega.',
      keyAreasLabel: 'Áreas de enfoque clave',
      items: [
        'Despliegue de funcionalidades 3 veces más rápido con Claude Code y Antigravity',
        'Rigor técnico en seguridad, escalabilidad y vías de conmutación por error',
        'Desarrollo orientado a especificaciones para código predecible, limpio y modular',
      ],
    },
    card2: {
      title: 'Cumplimiento normativo y visibilidad GEO',
      subtitle: 'Accesibilidad EAA, privacidad GDPR y preparado para búsqueda con IA',
      body: 'Me aseguro de que sus productos digitales cumplan con las estrictas regulaciones globales. Desarrollo con accesibilidad EAA/ADA (WCAG 2.2 AA) para eliminar riesgos legales e implemento seguimiento del lado del servidor (sGTM) para la privacidad. También optimizo la densidad de contenido para la Optimización de Motores Generativos (GEO) para asegurar citaciones de marca en las respuestas de IA.',
      keyAreasLabel: 'Áreas de enfoque clave',
      items: [
        'Cumplimiento estricto EAA/ADA (lectores de pantalla y navegación por teclado)',
        'Seguimiento del lado del servidor (sGTM) y analítica sin cookies para GDPR',
        'Estrategias GEO (densidad de hechos, sameAs) para Google AI Overviews y ChatGPT',
      ],
    },
  },
  contact: {
